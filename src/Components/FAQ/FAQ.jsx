      ...
      <div className="faq-faq">
        <div className="faq-faq_item">
          <div
            ...
            onClick={resetState}
            style={{ background: selected === "btn1" ? "#DCE8FA" : "#FFFFFF" }}
          >
          ...
          <div
            className="faq-faq_btn"
            style={{ background: selected === "btn2" ? "#DCE8FA" : "#FFFFFF" }}
            onClick={() => (
          ...
          <div
            className="faq-faq_btn"
            style={{ background: selected === "btn3" ? "#DCE8FA" : "#FFFFFF" }}
            onClick={() => (
          ...
          <div
            className="faq-faq_btn"
            style={{ background: selected === "btn4" ? "#DCE8FA" : "#FFFFFF" }}
            onClick={() => (
          ...
          <div
            className="faq-faq_btn"
            style={{ background: selected === "btn5" ? "#DCE8FA" : "#FFFFFF" }}
            onClick={() => (
